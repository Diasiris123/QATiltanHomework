...
public class TorchPerformanceTest
{
    ...
    public void Torch_LightUp_Performance()
    {
        ...
        UnityEngine.Debug.Log($"Lighting 1000 torches took {stopwatch.ElapsedMilliseconds}ms");

        Assert.Less(stopwatch.ElapsedMilliseconds, 200, "Performance: Lighting 1000 torches took too long");
    }
}